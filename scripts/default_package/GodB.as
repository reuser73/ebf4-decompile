package
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="GodB")]
   public dynamic class GodB extends FoeMC
   {
       
      
      public var cat:MovieClip;
      
      public function GodB()
      {
         super();
      ...
      {
         if(Global.battleState == 3 || Global.battleState == 5)
         {
            gotoAndPlay("intro2");
         }
      }
